...
`knowledge-processing.integration.spec.ts` 使用真实 PostgreSQL 验证：

1. 文件解析与OCR Outbox 能驱动 知识加工与质量 PASS，合格 Child 才进入待 Embedding；
...
```powershell
$env:TEMP='D:\codex-temp\rag-knowledge-processing'
$env:TMP='D:\codex-temp\rag-knowledge-processing'
