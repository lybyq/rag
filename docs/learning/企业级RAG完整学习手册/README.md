...
新增专题：[企业级 RAG 资深面试集（108 题、场景追问、源码证据与三张链路图）](../senior-rag-interview/README.md)。以 2026-09-24 代码审阅为基线，明确区分当前能力、内网 BM25 适配和未来 Agentic/Wiki 规划；新增传统 RAG 高级方案、LLM Wiki、Agentic RAG 三个独立专题。
...
如果目标是彻底吃透并经得住面试连续追问，不要先把 01～08 当提纲背诵，按下面四本“教学正册”学习：

| 顺序 | 教学正册                                                        | 作用                                                          |
| ---- | --------------------------------------------------------------- | ------------------------------------------------------------- |
| 1    | [09-从零到企业级 RAG 逐课精讲](./09-从零到企业级RAG逐课精讲.md) | 每个概念先讲人话、再讲原理、失败和练习                        |
| 2    | [10-真实代码与数据全链路导读](./10-真实代码与数据全链路导读.md) | 沿 Controller、Use Case、Port、Adapter、表和 Graph 节点读代码 |
| 3    | [11-架构选型与换场景决策手册](./11-架构选型与换场景决策手册.md) | 学会根据数据、风险、SLA 和资源重新选型                        |
| 4    | [12-企业级 RAG 面试连续深挖](./12-企业级RAG面试连续深挖.md)     | 主问题、连续追问、故障、换场景和高分回答                      |
| 验收 | [13-学习实验与答辩验收](./13-学习实验与答辩验收.md)             | 八周课程、手算、故障实验、闭卷题和 100 分量表                 |

01～08 是配套专题手册：在正册遇到概念时用于快速查阅、部署和复习。
...
| 第七遍：面试速查 | [07-企业级RAG面试深挖](./07-企业级RAG面试深挖.md)       | 快速复习基础题；深度训练转第 12 章      |
