...
| roundCount=2 仍为空                  | 数据/查询质量     | 应由 M08 澄清或拒答，不继续循环                 |

## Prometheus 指标

- `rag_m07_routes_total`
- `rag_m07_retrieval_routes_total`
- `rag_m07_query_embedding_cache_total`
- `rag_m07_removed_candidates_total`
- `rag_m07_stage_duration_seconds`
...
pnpm exec jest --runInBand --config test/jest-integration.config.cjs test/integration/m07-retrieval-source.integration.spec.ts
```
