        ...
        new HybridRetrievalService(
          {
            ...
            rewriteRequestTimeoutMs: config.llm.rewriteRequestTimeoutMs,
            ...
            embeddingQueryTemplateVersion: config.embedding.queryTemplateVersion,
            embeddingNormalizeDense: config.embedding.normalizeDense,
            embeddingOutputModes: config.embedding.outputModes,
            embeddingSparseFormatVersion: config.embedding.sparseFormatVersion,
          },
          source,
          authorization,
          protector,
