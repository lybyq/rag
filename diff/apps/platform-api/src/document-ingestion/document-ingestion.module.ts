/** 文档接入与任务 在 Platform API 中的 Composition Root。 */
...
import { DocumentBatchesController } from './document-batches.controller';

@Module({
  imports: [IdentityAccessModule, PostgresPersistenceModule, MinioPersistenceModule],
  controllers: [
    UploadsController,
    DocumentBatchesController,
